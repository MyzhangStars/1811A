layui.use(['jquery', 'element', 'layer', 'form', 'table'], function () {
    ...
    initChart();  //加载页面echart图表

    element.on('nav(menu)', function (elem) {
        var type = elem.attr('lay-type');
    ...
    element.on('nav(right-nav)', function (elem) {
        ...
        if (e == 'userInfo') {
            com.get('/Users/UserInfo', function (rtnStr) {
                layer.open({
                    type: 1,
                    title: '个人资料',
                    area: ['900px', '500px'],
            ...
            com.get('/Users/UpdatePass', function (rtnStr) {
                layer.open({
                    type: 1,
                    title: '修改密码',
                    area: ['600px', '300px'],
            ...
            com.get('/Home/Theme', function (rtnStr) {
                layer.open({
                    type: 1,
                    title: '主题',
                    content: rtnStr,
    ...
    function getMenu(id) {
        com.getAjax("/Home/GetLeftMenu", { parentID: id }, function (data) {
            $('#menu').html(data);
...
tpwidget("init", {
    ...
    "key": "4722eb04f6edd97b066826cce9f490c0"
});
tpwidget("show");